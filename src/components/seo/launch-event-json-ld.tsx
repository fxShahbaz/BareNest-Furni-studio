...
export default function LaunchEventJsonLd() {
  ...
  // Inauguration is at 11:00 IST; we don't have an end time so default
  // to +3 hours which is a typical opening ceremony slot.
  const start = SHOWROOM.inaugurationISO; // "2026-06-18T11:00:00+05:30"
  const end = "2026-06-18T14:00:00+05:30";
